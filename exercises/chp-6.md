...
1.기본키와 외래키인 경우 사용 
5. WHERE절 조건식에 자주 사용되는 테이블 열의 경우 사용, 갱신이 빈번한 테이블 열의 경우 사용하지않음
6. 가변길이 문자형이나 실수형, 날짜형 열보다는 정수형, 고정길이 문자형 열에 사용
7. ORDER BY절이나 GROUP BY절에 자주 사용되는 경우 사용
8. 범위검색을 하는 경우, 비사용
9. 열의 선택도가 높을경우 비사용
10. 테이블행 개수가 별로 없는 경우 비사용
